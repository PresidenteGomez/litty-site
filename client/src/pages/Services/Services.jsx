        ...
        <div>
          <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white ">
            <div class="my-3 py-3">
              ...
              <p class="lead">Learn more about about Community Solar Gardens. Subscriptions disregard if you own the property or rent it. This is a great option for anyone.</p>
              <a>
